...
gulp.task('watch', function () {
    // gulp.watch('./sass/**/*.scss', ['styles']); replaced this to make the souremaps work in development
    gulp.watch('./sass/**/*.scss', ['scss-for-dev']);
...
// _s SCSS module files
    gulp.src(basePaths.node + 'undescores-for-npm/sass/modules/*.scss')
        .pipe(gulp.dest(basePaths.dev + '/sass/underscores'));

// _s SCSS mixins files
    gulp.src(basePaths.node + 'undescores-for-npm/sass/mixins/*.scss')
        .pipe(gulp.dest(basePaths.dev + '/sass/underscores'));
